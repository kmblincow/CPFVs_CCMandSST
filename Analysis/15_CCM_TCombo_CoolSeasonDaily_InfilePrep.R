...
#Generating .Rdata file for the Cool daily Data (BF, AL, YF combined)
...
lib <- cbind(seq(1,2451, by = 245), seq(245, 2695, by = 245))
pred <- lib
...
save.image("CCM_TCombo_CoolSeasonDaily_SCB3.RData")
