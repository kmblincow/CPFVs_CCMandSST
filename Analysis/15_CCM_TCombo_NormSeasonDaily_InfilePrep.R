...
#Generating .Rdata file for the Norm daily Data (BF, AL, YF combined)
...
lib <- cbind(seq(1,3431, by = 245), seq(245, 3675, by = 245))
pred <- lib
...
save.image("CCM_TCombo_NormSeasonDaily_SCB3.RData")
