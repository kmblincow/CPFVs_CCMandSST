...
#load data
load("CCM_TCombo_CoolSeasonDaily_SCB3.Rdata")
                              ...
                              chunk)
{
  ...
  run_ccm <- function(i)
  {
    ...
    ccm_tp_zero <- ccm(temp_df, lib = lib, pred = pred, lib_sizes = seq(1, 2695, by = 245), #MADE CHANGES HERE!!!
...
compute_ccm_web_1(chunk = 11:15, out_file = "TCombo_CoolDaily_ccm_webs_3.Rdata")

compute_ccm_web_1(chunk = 16:20, out_file = "TCombo_CoolDaily_ccm_webs_4.Rdata")

compute_ccm_web_1(chunk = 21:25, out_file = "TCombo_CoolDaily_ccm_webs_5.Rdata")

compute_ccm_web_1(chunk = 26:30, out_file = "TCombo_CoolDaily_ccm_webs_6.Rdata")
...
load("TCombo_CoolDaily_ccm_webs_1.Rdata")
...
png(file = "ConvergencePlots_Cool.png",
    width = 1000, height = 750)
cool_convergence
dev.off()

#remove things we don't need for plotting the networks
...
save.image("TCombo_CoolDaily_ccm_webs_SCB3.RData")
...
png(file = "SignifancePlots_Cool.png",
    width = 1000, height = 750)
cool_significance
dev.off()
